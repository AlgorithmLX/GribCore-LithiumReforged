...
public class EntityClassGroup {
    ...
    static {
        String remapped_method_30948 = net.fabricmc.loader.api.FabricLoader.getInstance().getMappingResolver().mapMethodName("intermediary", "net.minecraft.class_1297", "method_30948", "()Z");
