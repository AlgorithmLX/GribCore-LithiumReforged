package gribland.gribcore.mixin.lithium.alloc.explosion_behavior;
...
public class EntityExplosionBehaviorMixin extends ExplosionDamageCalculator {
    ...
    public Optional<Float> getBlockExplosionResistance(Explosion explosion, BlockGetter world, BlockPos pos, BlockState blockState, FluidState fluidState) {
        Optional<Float> optionalBlastResistance = getBlockExplosionResistance(explosion, world, pos, blockState, fluidState);
