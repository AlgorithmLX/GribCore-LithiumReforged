package gribland.gribcore.mixin.lithium.collections.entity_filtering.movement;

import gribland.gribcore.entity.LithiumEntityCollisions;
import gribland.gribcore.lithium.common.shapes.VoxelShapeCaster;
...
import static gribland.gribcore.entity.LithiumEntityCollisions.EPSILON;
...
public class ChunkAwareBlockCollisionSweeper {
        ...
        do {
            do {
                ...
                if (this.cachedChunk != null && this.chunkY < 15 && this.chunkY < ((this.maxY + 1) >> 4)) {
                    ...
                    this.cachedChunk = (LevelChunk) this.view.getChunkForCollisions(this.chunkX, this.chunkZ);
     ...
     */
    private static boolean hasChunkSectionOversizedBlocks(LevelChunk chunk, int chunkY) {
